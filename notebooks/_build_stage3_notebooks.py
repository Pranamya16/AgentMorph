...
DRESS_REHEARSAL_CELLS: list[dict] = [
    ...
    md(
        "## 11. Error audit\n\n"
        "Count `[stage3-fail]` lines in the runner's stderr. Zero means clean. "
        "If non-zero, paste back here so we debug before the full sweep."
    ),
    code(
    ...
    md(
        "## 12. Gate check\n\n"
        "Copy this output to the chat side as part of the dress-rehearsal "
        "sign-off. If all gates green, proceed to `stage3_full_sweep.ipynb`."
    ),
    code(
        "gates = {\n"
